...
export const BorderLoadingIndicator = ({
  ...
  return (
    <>
      {/* Border overlay */}
      <div className="pointer-events-none absolute -top-[2px] -left-[2px] h-[calc(100%+4px)] w-[calc(100%+4px)]">
        <div
          className={cn(
        ...
        >
          <div
            className={cn(
              'absolute left-1/2 top-1/2 w-[140%] aspect-square',
              '-translate-x-1/2 -translate-y-1/2',
              'rounded-full',
              'animate-spin', // <-- Tailwind’s built-in keyframes
              'bg-[conic-gradient(from_0deg_at_50%_50%,rgba(42,67,233,0.5)_0deg,rgba(42,138,246,0)_360deg)]'
            )}
